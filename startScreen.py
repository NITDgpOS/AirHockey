...
def airHockeyStart(screen, clock, Scrwidth, Scrheight):   
    ...
    while True:
        ...
        if abs(mouse[0] - 200)< buttonRadius and abs(mouse[1] - 470 )< buttonRadius:
            buttonCircle(screen, green, (200,470), "Play", largeText, (255,255,255), (Scrwidth/2-200, Scrheight/2+170))
            if click[0] == 1:
                return 1
            
        else:
            buttonCircle(screen, dimgreen, (200,470), "Play", smallText, (255,255,255), (Scrwidth/2-200, Scrheight/2+170))

        #quit button
        if abs(mouse[0] - 600) < buttonRadius and abs(mouse[1] - 470) < buttonRadius:
            buttonCircle(screen, red, (600,470), "Quit", largeText, (255,255,255), (Scrwidth/2+200, Scrheight/2+170))
            if click[0] == 1:
                return 0            
        else:
            buttonCircle(screen, dimred, (600,470), "Quit", smallText, (255,255,255), (Scrwidth/2+200, Scrheight/2+170))
